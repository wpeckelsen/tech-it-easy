...
// Tip: wanneer we meerdere waardes uit een array willen terugbrengen tot één getal of één string, gebruik
// je hier gewoon een oude vertrouwde for-loop voor!
//
//     Opdracht 2a: Hoeveel tv's zijn er al verkocht? Schrijf een script dat dit berekent. Log de uitkomst in de console.


/*verkochte tv's eerst in een array zetten*/
const totalSales = inventory2.map( (soldTV) => {
    return soldTV.sold;
});

/*hier het totaal in opvangen*/
let sumOfSales = 0;

/*hier de loop die de array items bij elkaar optelt*/
for (let i = 0; i < totalSales.length; i++) {
    sumOfSales += totalSales[i];
}
...
const sumOfSalesDiv = document.getElementById ("salesSection");
sumOfSalesDiv.textContent = sumOfSales;
